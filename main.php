<?php
/**
* Telegram Bot example for Public Transport of napoli (Italy)
...
* and Ilaria Vitellio for publishing dataset on http://www.comune.napoli.it/flex/cm/pages/ServeBLOB.php/L/IT/IDPagina/29233
* @author @Piersoft
Funzionamento
- invio location
 ...
 function shell($telegram,$db,$text,$chat_id,$user_id,$location,$reply_to_msg)
{
	...
	$today = date("Y-m-d H:i:s");
		...
		if ($text == "/start") {
		$reply = "Benvenuto. Invia la tua posizione cliccando sulla graffetta (📎) e ti indicherò le fermate dell'Azienda Napoletana Mobilità più vicine nel raggio di 500 metri e relative linee ed orari";
		$reply .= "\nI dati dell'Azienda Napoletana Mobilità, in licenza opendata IoDL2.0, sono prelevabili su http://www.comune.napoli.it/flex/cm/pages/ServeBLOB.php/L/IT/IDPagina/29233";
  ...
  $distanza=[];
	...
	$log=$today. ";fermatenapoli sent;" .$chat_id. "\n";
