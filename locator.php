...
<div id="infodiv" style="leaflet-popup-content-wrapper">
  <p><b>Fermate Bus Napoli nelle vicinanze<br></b>
  Mappa con fermate, linee e orarie dei Bus dell'Azienda Napoletana Mobilità by @piersoft. Fonte dati Lic. IoDL2.0 <a href="http://www.comune.napoli.it/flex/cm/pages/ServeBLOB.php/L/IT/IDPagina/29233">ANM</a></p>
</div>
       ...
       var markers = L.markerClusterGroup({spiderfyOnMaxZoom: false, showCoverageOnHover: true,zoomToBoundsOnClick: true});
        ...
        function loadLayer(url)
        {
                var myLayer = L.geoJson(url,{
                        ...
                        marker.bindPopup('<img src="http://www.piersoft.it/napolitrasportibot/ajax-loader.gif">',{maxWidth:50, autoPan:true});
